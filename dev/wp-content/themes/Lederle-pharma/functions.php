...
function mytheme_custom_styles() {
    ...
    wp_enqueue_style( 'custom-style1', get_template_directory_uri() . '/assets/css/bootstrap.min.css');
     wp_enqueue_style( 'custom-style12', get_template_directory_uri() . '/assets/css/owl.carousel.min.css');
	wp_enqueue_style( 'custom-style2', get_template_directory_uri() . '/assets/css/magnific-popup.min.css');
	wp_enqueue_style( 'custom-style3', get_template_directory_uri() . '/assets/fonts/font-awesome/css/all.min.css');
	wp_enqueue_style( 'custom-style4', get_template_directory_uri() . '/assets/fonts/flaticon/flaticon.css');
	wp_enqueue_style( 'custom-style5', get_template_directory_uri() . '/assets/css/ionicons.min.css');
    wp_enqueue_style( 'custom-style6', get_template_directory_uri() . '/assets/fonts/themify-icons/themify-icons.css');
    wp_enqueue_style('custom-style7', get_template_directory_uri() . '/assets/css/style.css');
    wp_enqueue_style('custom-style8', get_template_directory_uri() . '/assets/css/responsive.css');
}
...
wp_enqueue_script( 'myscript1', get_template_directory_uri() . '/assets/js/jquery.min.js', array(), false, true );
wp_enqueue_script( 'myscript2', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array(), false, true );
wp_enqueue_script( 'myscript3', get_template_directory_uri() . '/assets/js/owl.carousel.min.js', array(), false, true );
wp_enqueue_script( 'myscript4', get_template_directory_uri() . '/assets/js/progressbar.js', array(), false, true );	
wp_enqueue_script( 'myscript5', get_template_directory_uri() . '/assets/js/isotope.pkgd.min.js', array(), false, true );	
wp_enqueue_script( 'myscript6', get_template_directory_uri() . '/assets/js/jquery.countTo.min.js', array(), false, true );	
wp_enqueue_script( 'myscript7', get_template_directory_uri() . '/assets/js/jquery.magnific-popup.min.js', array(), false, true );  
wp_enqueue_script( 'myscript8', get_template_directory_uri() . '/assets/js/wow.min.js', array(), false, true ); 
wp_enqueue_script( 'myscript9', get_template_directory_uri() . '/assets/js/custom.js', array(), false, true ); 
